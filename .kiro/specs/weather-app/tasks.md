...
- [ ] 2. Create API utility and configuration
  - [ ] 2.1 Implement API configuration with placeholder key
  ...
  - [ ] 2.2 Implement weather data fetch function with error handling
...
- [ ] 3. Build Loader component
  - [ ] 3.1 Create Loader.jsx with spinning animation
...
- [ ] 4. Build ErrorMessage component
  - [ ] 4.1 Create ErrorMessage.jsx to display error messages
...
- [ ] 5. Build WeatherCard component
  - [ ] 5.1 Create WeatherCard.jsx structure and layout
...
- [ ] 6. Build SearchBar component
  - [ ] 6.1 Create SearchBar.jsx with input and buttons
  ...
  - [ ] 6.2 Implement search event handlers
...
- [ ] 7. Build main App component
  - [ ] 7.1 Create App.jsx with state management
    - Implement functional component with useState hooks
    - Define state variables: weatherData, loading, error, city
    - _Requirements: 8.1_
  
  - [ ] 7.2 Implement fetchWeather function in App
  ...
  - [ ] 7.3 Implement handleSearch callback
  ...
  - [ ] 7.4 Implement geolocation feature
  ...
  - [ ] 7.5 Implement conditional rendering logic
  ...
  - [ ] 7.6 Implement dynamic background based on weather
...
- [ ] 8. Create global styles and theme
  - [ ] 8.1 Create index.css with CSS variables and global styles
  ...
  - [ ] 8.2 Create App.css with layout and responsive styles
...
- [ ] 9. Set up application entry point
  - [ ] 9.1 Create index.js to render App component
